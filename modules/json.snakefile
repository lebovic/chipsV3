...
rule json_conservation:
    ...
    shell:
        src_path + "/modules/scripts/json/json_conserv.py -i {input} -o {output.json} {params.basics} {params.factor} {params.TF} -r {wildcards.run}"
...
#     log: _logfile
#     shell:
#         src_path + "/modules/scripts/json/json_comtamination.py -i {input} -o {output} -I {wildcards.sample} -s {wildcards.sample}"
...
rule json_dhs:
    ...
    # log: output_path + "/logs/json/{sample}.log"
    shell:
        src_path + "/modules/scripts/json/json_dhs.py -i {input} -o {output}"
...
#     message: "JSON: generate velcro json"
    # log: output_path + "/logs/json/{sample}.log"
#     shell:
#         src_path + "/modules/scripts/json/json_velcro.py  "
...
rule json_enrichMeta:
    ...
    # log: output_path + "/logs/json/{sample}.log"
    shell:
        src_path + "/modules/scripts/json/json_enrich_meta.py -i {params.meta_files} -o {output} -m {params.mapped_files} -D {input.dhs} {params.has_dhs} -d {params.down} -r {run} -s {params.sample_name}"
...
rule json_fastqc:
    ...
    # log: output_path + "/logs/json/{sample}.log"
    shell:
        src_path + "/modules/scripts/json/json_fastqc.py {params.fastqc_data} -o {output}{params.sample_name} -r {run}"
...
rule json_frag:
    ...
    # log: output_path + "/logs/json/{sample}.log"
    shell:
        src_path + "/modules/scripts/json/json_frag.py -r {input} -o {output.json} -R {params.sd_R} {params.frag_tool} {params.sample_name}"
...
rule json_frip:
    ...
    # log: output_path + "/logs/json/{sample}.log"
    shell:
        src_path + "/modules/scripts/json/json_frip.py {params.input_file} -o {output}{params.sample_name}"
...
rule json_macs2:
    ...
    # log: output_path + "/logs/json/{sample}.log"
    shell:
        src_path + "/modules/scripts/json/json_macs2.py -i {input} -o {output} -I {wildcards.run}"
...
rule json_macs2Rep:
    ...
    # log: output_path + "/logs/json/{sample}.log"
    shell:
        src_path + "/modules/scripts/json/json_macs2_rep.py -i {input} -o {output} {params.sample_name} "
...
rule json_map:
    ...
    # log: output_path + "/logs/json/{sample}.log"
    shell:
        src_path + "/modules/scripts/json/json_map.py{params.input_file} -o {output} "
...
rule json_meta:
    ...
    # log: output_path + "/logs/json/{sample}.log"
    shell:
        src_path + "/modules/scripts/json/json_meta.py -i {input} -o {output} -I {wildcards.run} "
...
rule json_pbc:
    ...
    # log: output_path + "/logs/json/{sample}.log"
    shell:
        src_path + "/modules/scripts/json/json_pbc.py{params.input_file} -o {output}"
...
rule json_seqpos:
    ...
    # log: output_path + "/logs/json/{sample}.log"
    shell:
        src_path + "/modules/scripts/json/json_seqpos.py -i {input} -o {output} -p {params.prefix}"
# rule json_rep:
#     input:
...
#     log: output_path + "/logs/json/{sample}.log"
#     shell:
#         src_path + "/modules/scripts/json/json_rep.py -c {input.cor} -o {output} -O {input.overlap} -i {run}" 
