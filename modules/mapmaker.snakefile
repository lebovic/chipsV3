...
rule mapmaker_config:
    ...
    # run:
        ...
        # shell(src_path + "/modules/scripts/mapmaker_config.py -n {names} -b {bed_files} -w {bw_files} -a {bam_files} -i {igv_files} -c {input.config} -o {output}")
    shell:
      src_path + "/modules/scripts/mapmaker_config.py {params.names} {params.bed_files} {params.bw_files} {params.bam_files} {params.igv_files} -c {input.config} -o {output}"  
...
rule mapmaker_meta:
    ...
    # run:
    #     names = " -n ".join(params.run_names)
    #     shell(src_path + "/modules/scripts/mapmaker_meta.py -n {names} -o {output}")
    shell:
        src_path + "/modules/scripts/mapmaker_meta.py {params.names} -o {output}"
